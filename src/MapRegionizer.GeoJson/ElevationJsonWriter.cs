...
public static class ElevationJsonWriter
{
    ...
    private static char TerrainClassCode(TerrainClassKind terrainClass) => terrainClass switch
    {
        ...
        TerrainClassKind.DeepChannel => 'C',
        TerrainClassKind.ShallowBank => 'K',
        TerrainClassKind.AbyssalBasin => 'Y',
        TerrainClassKind.SubmarineRidge => 'R',
        TerrainClassKind.Trench => 'N',
        TerrainClassKind.StraitDepth => 'Z',
        TerrainClassKind.InlandSeaDepth => 'W',
        TerrainClassKind.Beach => 'B',
        TerrainClassKind.CoastalPlain => 'L',
