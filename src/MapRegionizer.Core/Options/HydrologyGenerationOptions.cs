...
public sealed class HydrologyGenerationOptions
{
    ...
    public double ChannelCurvatureStrength { get; init; } = 1.0;
    ...
    public void Validate()
    {
        ...
        if (ChannelCurvatureStrength < 0 || ChannelCurvatureStrength > 2) throw new ArgumentOutOfRangeException(nameof(ChannelCurvatureStrength), "Channel curvature strength must be in [0, 2].");
