...
public sealed class ClimateGenerationOptions
{
    ...
    public double BaseRainfallEfficiency { get; init; } = 0.12;
    public double OrographicStrength { get; init; } = 0.80;
    public double DescentDrying { get; init; } = 0.34;
    public double ContinentalDrying { get; init; } = 0.20;
